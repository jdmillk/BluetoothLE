package md5e00a85939f2b86175b81dfcfdd666d17;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.BLE.Android.Adapter+Api21BleScanCallback, Plugin.BLE, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", Adapter_Api21BleScanCallback.class, __md_methods);
	}


	public Adapter_Api21BleScanCallback () throws java.lang.Throwable
	{
		super ();
		if (getClass () == Adapter_Api21BleScanCallback.class)
			mono.android.TypeManager.Activate ("Plugin.BLE.Android.Adapter+Api21BleScanCallback, Plugin.BLE, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
